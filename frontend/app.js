...
// ---------- KOSHA 가이드 ----------
// 법령/고시와 달리 KOSHA GUIDE는 공개 조회 API가 없어(models.KoshaGuide
// 설명 참고) 사용자가 직접 등록하거나 붙여넣은 것만 대상이 된다. CRUD +
// 이 데이터셋 안에서만 도는 키워드 검색을 제공한다(법령 키워드 검색과
// 같은 사용 경험을 별도 데이터셋에 대해 제공하는 것이 목적).
...
async function loadKoshaGuides() {
  try {
