...
1. 아래 둘 중 한 방법으로 `SafetyLawMonitorSetup.exe`를 만든다.
...
3. 받는 사람에게 **`SafetyLawMonitorSetup.exe` 와 `installer/설치안내.txt`
...
결과물: `installer/build/SafetyLawMonitorSetup.exe` (약 21MB)
